# Disk Demo 101: Disk Utilization & Remediation Workflow (sean-test sandbox)

**Sean-test copy** — identical playbooks and AO workflow to [`disk-utilization/101-disk-threshold-routing/`](../../disk-utilization/101-disk-threshold-routing/). Used to experiment with custom Mermaid diagram assets on the demo marketplace.
